...
class ResNetEncoder(nn.Module):
    ...
    def __init__(self, n_tasks=14, num_blocks=(3, 4, 6, 3),
                 in_channels=3, activation="elu"):
...
class ResNet34(nn.Module):
    ...
    def __init__(self, n_tasks=14, activation="elu"):
        super(ResNet34, self).__init__()

        self.n_tasks = n_tasks
        self.activation = activation
        self.fe = torchvision.models.resnet34(weights='IMAGENET1K_V1')
...
if __name__ == '__main__':
    ...
    print(sum([torch.numel(i) for i in list(net.parameters())]))

    net2 = resnet34()
    print(sum([torch.numel(i) for i in list(net2.parameters())]))

    net3 = ResNet34()
    print(sum([torch.numel(i) for i in list(net3.parameters())]))
    net3(torch.randn((5, 3, 224, 224)))
